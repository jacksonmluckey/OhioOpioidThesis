...
crude_rate_individual <- regression_formula("`Fatal Overdose Crude Rate`", "`Median Individual Income`")
crude_rate_individual_FE <- regression_formula("`Fatal Overdose Crude Rate`", "`Median Individual Income`", "Year")
stargazer(
