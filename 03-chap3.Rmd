...
```{r regressionFormula}
regression_formula <- function(rate_variable, income_variable, fixed_effects) {
...
```{r generateYearFixedEffects}
```

```{r generateCountyFixedEffects}
```
