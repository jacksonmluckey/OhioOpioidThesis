...
$$\hypertarget{household-vs-individual-income}{%
\subsection{Household vs Individual Income}\label{household-vs-individual-income}}
\begin{sidewaystable}[!htbp] \centering 
  \caption{Does Individual vs Household Income Significantly Change the Model?} 
  \label{} 
\small 
...
\hline \\[-1.8ex] 
 Median Household Income & $-$0.0003 (0.0002) &  & $-$0.00000 (0.0002) &  \\ 
  ...
  Density: Large Fring Metro & 11.548$^{***}$ (3.028) & 10.151$^{***}$ (3.148) & $-$0.460 (3.125) & $-$1.360 (3.155) \\ 
...
$$\hypertarget{fatal-overdose-rate-metrics}{%
\subsection{Fatal Overdose Rate Metrics}\label{fatal-overdose-rate-metrics}}
\begin{sidewaystable}[!htbp] \centering 
...
\hline \\[-1.8ex] 
 Median Household Income & $-$0.00000 (0.0002) & 0.0001 (0.0004) & 0.00001 (0.0002) \\ 
  ...
  Density: Large Fring Metro & $-$0.460 (3.125) & $-$9.749 (8.603) & 1.067 (3.097) \\ 
...
```{r doCountyFixedEffectsMatter, eval=FALSE}
stargazer(
  crude_rate_acs1,
  county_FE_acs1,
  crude_rate_acs5,
...
$$\hypertarget{county-fixed-effects}{%
\subsection{County Fixed Effects}\label{county-fixed-effects}}
\begin{verbatim}
\begin{sidewaystable}[!htbp] \centering 
...
\hline \\[-1.8ex] 
 Median Household Income & $-$0.0003 (0.0002) & $-$0.0004$^{*}$ (0.0002) & $-$0.00000 (0.0002) & 0.001 (0.001) \\ 
  ...
  Density: Large Fring Metro & 11.548$^{***}$ (3.028) & $-$1.070 (15.212) & $-$0.460 (3.125) & $-$70.650 (45.792) \\ 
