...
# with imputed values
imputed_formula <- regression_forumula("`Fatal Overdose Rate (Includes Imputed)`", "`Median Household Income`", "Year")
...
```{r showThatHouseholdAndIndividualIncomeNotDifferent}
