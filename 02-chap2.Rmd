...
Disability is broken into age and sex bins. These bins are kept small due to complications in aggregating them.
...
The distribution of the fatal drug overdose rate between counties suggests that censoring is occuring from the bottom. This is the right-side tail is significantly longer and fatter than the left-side tail [@hareThesisMeetings2019].
