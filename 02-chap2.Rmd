...
```{r summary_stats_prep, include=FALSE}
summary_stats <- df %>%
...
In general, it appears that disability statistics become more accurate as the age bin increases. This makes intuitive sense, as disability rates presumably increase as age increases, so there would be less variability as age increases, especially in counties with a smaller population. The presence of observations with zero children under the age of five with disabilities confirms this intuition.
