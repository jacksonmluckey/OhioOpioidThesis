...
The majority of variables are in percentage form in order to isolate the role of county population on the fatal drug overdose rate.. These variables are identified by the "%" in their name. Percentages are calculated dividing the raw count from the Census/CDC by the total population of the county that year. Percentages are stored in the format XX.X%, rather than .XXX%.
